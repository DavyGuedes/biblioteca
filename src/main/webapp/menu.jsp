    ...
    <div class="container p-5">
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto my-lg-5">
                <h1 class="display-4 font-weight-normal">Sistema Biblioteca</h1>
        ...
        <div class="row mb-2">
            <div class="col-md-6">
                <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                    ...
                    <img class="card-img-right flex-auto d-none d-lg-block" src="/images/books.png" alt="Thumbnail [200x250]" style="width: 200px; height: 250px;">
                </div>
            </div>
            <div class="col-md-6">
                <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                    ...
                    <img class="card-img-right flex-auto d-none d-lg-block" src="/images/library.png" alt="Thumbnail [200x250]" style="width: 200px; height: 250px;">
                </div>
            </div>
        </div>
    </div>
